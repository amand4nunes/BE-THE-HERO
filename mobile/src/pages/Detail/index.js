...
export default function Detail() {
    ...
    const message = `Olá ${incident.nome}, estou entrando em contato pois gostaria de ajudar no caso ${incident.titulo} com o valor de 
        ...
        <View style={styles.container}>
            <View style={styles.header}>
                ...
                <TouchableOpacity onPress={navigateBack}>
                    <Feather name="arrow-left" size={28} color={"#a82041"} />
                </TouchableOpacity>
            </View>
